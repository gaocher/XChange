package info.bitrich.xchangestream.binance.test;

import static info.bitrich.xchangestream.binance.BinanceStreamingExchange.USE_HIGHER_UPDATE_FREQUENCY;

import info.bitrich.xchangestream.binance.BinanceStreamingExchange;
import info.bitrich.xchangestream.binance.ContractBinanceStreamingExchange;
...
public class ContractBinanceManualExampleTest {
  private static final Logger LOG = LoggerFactory.getLogger(ContractBinanceManualExampleTest.class);
  //PERP

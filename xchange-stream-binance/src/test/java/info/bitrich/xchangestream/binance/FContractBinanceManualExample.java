...
public class FContractBinanceManualExample {
  private static final Logger LOG = LoggerFactory.getLogger(FContractBinanceManualExample.class);
  ...
  public static void main(String[] args) throws InterruptedException {
    ...
    ExchangeSpecification spec =
        StreamingExchangeFactory.INSTANCE
            .createExchange(FContractBinanceStreamingExchange.class.getName())
